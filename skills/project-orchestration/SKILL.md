...
- Use `codex-subagent` after the parallelization decision when a concrete `codex exec` delegation prompt, read/write boundary, or independent verifier pass is needed.
