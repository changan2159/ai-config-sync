---
name: design-review
description: "Review a web app or page for visual design quality: layout, typography, spacing, color, hierarchy, consistency, interaction patterns, and responsive behavior. Use when the user asks for a design review, visual review, layout check, polish pass, screenshot review, or says a UI looks off, ugly, cramped, unprofessional, inconsistent, too empty, too wide, or not polished. Produces prioritized design findings and uses browser screenshots when feasible."
---
